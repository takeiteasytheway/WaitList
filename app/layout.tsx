...
export const metadata: Metadata = {
  title: "Waitlist - Spend Any Crypto, Anywhere | Virtual & Physical Crypto Cards",
  description: "Transform your crypto into spendable currency with Waitlist's virtual and physical cards. Accepted at 40M+ merchants worldwide, zero hidden fees, and instant virtual cards. No KYC required for early adopters.",
  keywords: [
    "crypto cards",
    "virtual cards",
    ...
    "Waitlist.de",
    "Waitlist protocol",
    "Waitlist protocol card", 
    "Waitlist finance",
    "Waitlist finance card",
    "Waitlist finance protocol",
    "Waitlist finance protocol card",  
  ],
  authors: [{ name: "Waitlist Team" }],
  creator: "Waitlist",
  publisher: "Waitlist",
  formatDetection: {
    email: false,
  ...
  metadataBase: new URL('https://Waitlist.io'),
  alternates: {
    canonical: '/',
    languages: {
      'en-US': '/en-US',
  ...
  openGraph: {
    title: "Waitlist - Spend Any Crypto, Anywhere",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Waitlist Crypto Cards - Spend Any Crypto, Anywhere with Virtual & Physical Cards',
        type: 'image/png',
      },
    ],
    locale: 'en_US',
  ...
  other: {
    'apple-mobile-web-app-title': 'Waitlist',
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "name": "Waitlist",
              "description": "Transform your crypto into spendable currency with Waitlist's virtual and physical cards. Accepted at 40M+ merchants worldwide.",
              "url": "https://Waitlist.io",
              "logo": "https://Waitlist.io/Waitlist-logo.svg",
              "image": "https://Waitlist.io/twitter-image.png",
              "sameAs": [
                "https://twitter.com/Waitlist",
                "https://discord.gg/Waitlist",
                "https://t.me/Waitlist"
              ],
              "contactPoint": {
                "@type": "ContactPoint",
