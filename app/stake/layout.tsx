...
export const metadata: Metadata = {
  title: 'Stake BBLP Tokens | Waitlist - Earn Passive Income & Rewards',
  ...
  keywords: 'BBLP staking, crypto staking, passive income, staking rewards, Waitlist staking, yield farming',
  openGraph: {
    title: 'Stake BBLP Tokens | Waitlist - Earn Passive Income & Rewards',
